...
public class MedicoInterfaz extends PacienteInterfaz {
    ...
    public JButton btnMisCitas, btnHistorial, btnComentarios, btnNotificaciones, btnMiAgenda, btnConsultorio, btnBuscar,
            pruebaFicha, simboloRegresarConfirmacionP, btnAsistio, btnNoAsistio, btnGuardarFicha;
    ...
    public MedicoInterfaz(String nombre, String nombreInterfaz, String rutaFotoP) {
        ...
        pruebaFicha = new JButton("ficha tecnica");
        ...
        MetodosPublicos.estilizarBoton(pruebaFicha, (byte) 5);
        pruebaFicha.setPreferredSize(new Dimension(130,30));
    ...
    public void mostrarVistaConfirmacionAsistencia(){
        ...
        tituloConfirmacion.setBorder(new EmptyBorder(20,0,0,0));
    ...
    public void mostrarVistaFichaClinica(){
        ...
        diagnostico.setBorder(new EmptyBorder(10,0,10,0));
